          ...
          <table class="table table-bordered">
            ...
            <tbody style="text-align: center;">
              <tr>
                <?php
                    $i = 1;
                   foreach ($perpanjangiklan as $row) {
                    $iklan = $this -> db -> get_where('iklan', ['id' => $row['id_iklan']]) -> row_array();
                  ?>
                <th scope="row"><?= $i++?></th>
                <td><?= $row['nama'] ?></td>
                <td><img src="<?= base_url('img/galeri/iklan/') . $iklan['image'];?>" class="img-fluid" style=" height: 100px; width: 300px;"></td>
                <td><img src="<?= base_url('img/admin/bukti_pembayaran/') . $row['bukti'];?>" class="img-fluid" style=" height: 100px; width: 300px;"></td>
              ...
              <div class="modal-dialog modal-mt" style="margin-top: 200px;">
                ...
                <div class="modal-content">
                  <form method="post" action="<?php echo base_url()?>admin/perpanjang_iklan" enctype="multipart/form-data">
                  ...
                  <div class="modal-body">
                    <input type="hidden" name="id_iklan" class="form-control" value="<?= $row['id_iklan']?>">
                    <input type="hidden" name="id_perpanjang" class="form-control" value="<?= $row['id']?>">
