 ...
 */
 // AIzaSyCe-ATr5DpcYujuuGPiz5Af5GJANkm61MQ place
// AIzaSyCPcLlmqybKSe8cvN_leVX_1tkuO_-aKLo maps
// AIzaSyDztlrk_3CnzGHo7CFvLFqE_2bUKEq1JEU&libraries=places
// KAjsiUyT_OIsuISYEkXFK9Iso7S-ks97FsgaYst
//AIzaSyCe-ATrsDpcYujuuGPiz5Af5GJANkm61MQ
//AIzaSyA8oILU5368ADwx-SYGW9ZehQYIAROEnB4
// AIzaSyA30maGqI3wiLrwrNMLfhvTSWZELANRW1s

// <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA30maGqI3wiLrwrNMLfhvTSWZELANRW1s&language=id&region=ID"></script>
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyA8oILU5368ADwx-SYGW9ZehQYIAROEnB4'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $center						= "3.5912919, 98.6675712";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
	...
	var $map_width					= "50%";					// The width of the map container. Any units (ie 'px') can be used. If no units are provided 'px' will be presumed
