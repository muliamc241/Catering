    ...
    <header class="header mb-5">
      ...
      *** TOPBAR ***
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container"><a href="../index.php" class="navbar-brand home"><img src="<?= base_url('img/logo1.png')?>" alt="Obaju logo" class="d-none d-md-inline-block"><img src="<?= base_url('img/logo-small1.png')?>" alt="Obaju logo" class="d-inline-block d-md-none"><span class="sr-only">go to homepage</span></a>
